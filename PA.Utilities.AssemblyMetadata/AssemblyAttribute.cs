...
namespace PA.Utilities.AssemblyMetadata
{
    ...
    {
        public System.Collections.Generic.IEnumerable<NuGet.Packaging.FrameworkAssemblyReference> FrameworkAssemblies { get; private set; }
        public AssemblyFrameworkAssembliesAttribute() : this(default(System.Collections.Generic.IEnumerable<NuGet.Packaging.FrameworkAssemblyReference>)) { }
        public AssemblyFrameworkAssembliesAttribute(System.Collections.Generic.IEnumerable<NuGet.Packaging.FrameworkAssemblyReference> value) { this.FrameworkAssemblies = value; }
        public AssemblyFrameworkAssembliesAttribute(params NuGet.Packaging.FrameworkAssemblyReference[] value) { this.FrameworkAssemblies = value; }
    }

    [AttributeUsage(AttributeTargets.Assembly)]
    public class AssemblyPackageAssemblyReferencesAttribute : Attribute
    {
        public System.Collections.Generic.ICollection<NuGet.Packaging.PackageReferenceSet> PackageAssemblyReferences { get; private set; }
        public AssemblyPackageAssemblyReferencesAttribute() : this(default(System.Collections.Generic.ICollection<NuGet.Packaging.PackageReferenceSet>)) { }
        public AssemblyPackageAssemblyReferencesAttribute(System.Collections.Generic.ICollection<NuGet.Packaging.PackageReferenceSet> value) { this.PackageAssemblyReferences = value; }
    }

    [AttributeUsage(AttributeTargets.Assembly)]
    public class AssemblyDependencyGroupAttribute : Attribute
    {
        public System.Collections.Generic.IEnumerable<NuGet.Packaging.PackageDependencyGroup> DependencySets { get; private set; }
        public AssemblyDependencyGroupAttribute() : this(default(System.Collections.Generic.IEnumerable<NuGet.Packaging.PackageDependencyGroup>)) { }
        public AssemblyDependencyGroupAttribute(System.Collections.Generic.IEnumerable<NuGet.Packaging.PackageDependencyGroup> value) { this.DependencySets = value; }
        public AssemblyDependencyGroupAttribute(params NuGet.Packaging.PackageDependencyGroup[] value) { this.DependencySets = value; }
    }
